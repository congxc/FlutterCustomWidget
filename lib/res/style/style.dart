...
class Resources {
  ...
  static String getDrawable(String name) {
    return resources + drawable + name;
  }

  static String getJson(String name) {
    return resources + json + name;
  }
}
...
class AppColors {
  ...
  static const Color mapBackgroundColor = Color(0xFF7F7F7F);
  static const Color normalMarkTagBgColor = Color(0xFF3879F2);
  static const Color selectedMarkTagBgColor = Color(0xFF0E5BEB);
...
//  static const int primaryDarkValue = 0xFF121917;
  static const int primaryValue = 0xFF040116;
